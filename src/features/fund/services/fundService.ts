...
} from "@/features/shared/types/apiResponses";
...
export const getFunds = async (
  page: number = 1,
  limit: number = 10,
): Promise<successResponseWithPagination<Fund>> => {
...
export const buyFund = async (
  fundId: string,
  quantity: number,
): Promise<successResponse<Portfolio[]>> => {
