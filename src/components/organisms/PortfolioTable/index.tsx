                ...
                <div className={actionsCell}>
                  <ActionMenu
                    options={[
                      {
                        label: "Comprar",
                        onClick: () => handleAction(PortfolioAction.Buy, item),
                      },
                      {
                        label: "Vender",
                        onClick: () => handleAction(PortfolioAction.Sell, item),
                      },
                      {
                        label: "Traspasar",
                        onClick: () =>
                          handleAction(PortfolioAction.Transfer, item),
                      },
                      {
                        label: "Ver Detalle",
                        onClick: () =>
                          handleAction(PortfolioAction.Detail, item),
                      },
                    ]}
                  />
                </div>
